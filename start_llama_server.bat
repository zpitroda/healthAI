...
llama-server.exe -m "%MODEL_PATH%" -ngl 99 -c 16384 -b 2048 -fa on -ctk q8_0 -ctv q8_0 --spec-type draft-mtp --spec-draft-n-max 2 --jinja --reasoning-effort medium --reasoning-format deepseek --load-mode mlock --port 8080
